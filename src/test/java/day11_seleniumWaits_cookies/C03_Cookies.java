...
public class C03_Cookies extends TestBase {
    ...
    public void test01(){
        ...
        Cookie beninCookie=new Cookie("en sevdigim cookie","cikolatali");
        driver.manage().addCookie(beninCookie);
        ...
        Assert.assertTrue(cookieSkin==0);
        // 8- tum cookie’leri silin ve silindigini test edin
        driver.manage().deleteAllCookies();
        cookiesSeti=driver.manage().getCookies();
        System.out.println("silinen cookies seti : "+cookiesSeti);
    }
}
