...
public class C02_ExplictlyWait {
    ...
    public void explicitWaitTest(){
        ...
        // ExplicitliyWait icin once wait objesi olusturalim

        WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(30));

        // Bundan sonra ki adimi belirlerken
        // islem yapmak istedigimiz elementin
        // locate edilebilir olup olmadigi önemlidir
        // eger locate edilebilinirse once locate edip,
