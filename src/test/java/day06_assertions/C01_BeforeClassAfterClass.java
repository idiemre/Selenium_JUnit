...
public class C01_BeforeClassAfterClass {
    ...
    // 1. method'da amazona gidip amazona gittigimizi test edin
    // 2. method'da amazonda nutella aratip sonuclarin nutella icerdigini test edin
    // 3. method'da nutella arama sonuc sayisinin 50'den fazla oldugunu test edin

    static WebDriver driver;

    @BeforeClass
    // @BeforeClass ve @AfterClass notasyonu kullanan metgod'lar
    ...
    @Test
    public void test01(){
        // 1. method'da amazona gidip amazona gittigimizi test edelim
        ...
        if (actualTitle.contains(expectedKelime)){
            System.out.println("Amazona gidis testi PASSED");
        }else{
            System.out.println("Amazona gidis testi FAILED");
        }
